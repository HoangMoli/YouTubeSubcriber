...
class GAuth(object):
    ...
    def __g_token(self):
        ...
        data = {
            ...
            'hl': 'en',
            'f.req': '["{email}","",[],null,"EG",null,null,2,false,true,[null,null,[2,1,null,1,"https://accounts.google.com/ServiceLogin?hl=en&passive=true&continue=https%3A%2F%2Fwww.google.com.eg%2F",null,[],4,[],"GlifWebSignIn"],1,[null,null,[],null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,[],null,null,null,[],[]],null,null,null,true],"{email}"]'.format(
                email=self.email),
        ...
        response = self.session.post('https://accounts.google.com/_/signin/sl/lookup?hl=en&_reqid=144088&rt=j',
    ...
    def Glogin(self):
        botguard_token = self.__botguard_generate_token(
            re.findall(r'&quot;(eLC.*?)&quot;', self.session.get("https://accounts.google.com/signin").text))
        ...
        response = self.session.post('https://accounts.google.com/_/signin/sl/challenge', headers=headers, data=data,
                                     verify=False)
